...
def select_target_box(
        ...
        stride: float, sample_num, momentum_per, momentum: Optional[Tuple[float, float]] = None
...
def refined_force_pos(
    ...
    left_cell_set = deepcopy(movable_set)
...
if __name__ == '__main__':
    ...
    rlp = refined_force_pos(layout_, box_w=100, box_h=100, density_threshold=0.001, stride_per=0.5, epochs=5,
